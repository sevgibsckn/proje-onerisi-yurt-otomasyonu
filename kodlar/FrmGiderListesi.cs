...
namespace YurtKayitSistemi
{
    public partial class FrmGiderListesi : Form
    {
        ...
        {
            // TODO: Bu kod satırı 'yurtOtomasyonuDataSet4.Gider' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.giderTableAdapter.Fill(this.yurtOtomasyonuDataSet4.Gider);
